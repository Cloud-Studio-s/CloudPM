...
JIT_WARNING
	...
	function server(){
		...
		do{
			...
			/* Coming Soon
			$optimizerConfigPath = $dataPath . "server-optimizer.yml";

			$optimizerConfig = new Config($optimizerConfigPath, Config::YAML, [
				"server-optimizer" => [
					"tick-entities" => true,
					"tick-animals" => true,
					"tick-monsters" => true,
			...
			$settings = $optimizerConfig->get("server-optimizer");

			ServerOptimizerSettings::$tickEntities = (bool)$settings["tick-entities"];
			ServerOptimizerSettings::$tickAnimals = (bool)$settings["tick-animals"];
			ServerOptimizerSettings::$tickMonsters = (bool)$settings["tick-monsters"];
			ServerOptimizerSettings::$tickDrops = (bool)$settings["tick-drops"];
			*/
