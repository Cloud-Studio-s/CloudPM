...
final class KnownTranslationFactory{
	...
	public static function pocketmine_cloud_info(Translatable|string $param0, Translatable|string $param1) : Translatable{
		return new Translatable(KnownTranslationKeys::CLOUDPM_INFO, [
			0 => $param0,
			1 => $param1,
		]);
	}
