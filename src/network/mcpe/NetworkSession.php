...
class NetworkSession{
	...
	/** Serializer riutilizzato per i pacchetti in uscita, per ridurre allocazioni */
	private ByteBufferWriter $packetSerializer;
	...
	public function __construct(
		...
		$this->packetSerializer = new ByteBufferWriter();
