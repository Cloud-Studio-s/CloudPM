...
$defaultConfig = yaml_parse(Filesystem::fileGetContents(dirname(__DIR__) . '/resources/cloudpm.yml'));

if(!is_array($defaultConfig)){
	fwrite(STDERR, "Invalid default cloudpm.yml\n");
	exit(1);
}
...
/**
 * @internal
 * Constants for all properties available in cloudpm.yml.
